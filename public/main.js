...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _components_home_home_component__WEBPACK_IMPORTED_MODULE_9__["HomeComponent"]],
            imports: [
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(service) {
        ...
        this.url = 'http://localhost:3000/api/2Zxbr1';
    }
    HomeComponent.prototype.ngOnInit = function () { };
    HomeComponent.prototype.generateApi = function () {
        var _this = this;
        this.service.createAPI(this.inputjson).subscribe(function (res) {
            _this.printUrl(res);
        });
